...
public class LdapController {
	...
	@GetMapping("/authenticateForPassApp")
	public boolean authenticateForPassApp(@RequestParam @NotBlank @UsernameEmail final String username,
			@RequestParam @NotBlank final String password) {
		log.debug("Authentication begins for email : {} ", username);
		return userRepo.authenticateForPassApp(username, password);
	}
	...
	public List<String> autoSuggestion(@RequestParam @NotBlank final String mail) {
		log.debug("Finding user through uid or mail or equivalent : {} ", mail);
		return userRepo.autoSuggestion(mail);
	}
